...
1. In which type of cloud computng model does the customer have the least control over the infrastructure?
...
- [ ] User authentication
- [ ] Email encryption
- [x] Validate ownership of a public key
- [ ] Provide secure wireless connection
...
- [x] Distributed Denial of Service (DDoS) attack
...
- [x] Responding effectively to security incidents

14. Identify two characteristics of a DDoS attack.
- [x] Overwhelms a target's resources
- [ ] Originates from a single source
- [x] Utilizes multiple compromised systems
...
- [x] Educate employees about security policies
- [ ] Train employees on using new software
- [ ] Improve hardware maintenance skills
- [x] Increase awareness about social engineering attacks
...
- [ ] Filtering spam
- [ ] Encrypting data
- [x] Detecting and analyzing attacks

39. In cybersecurity, what is the principle of least privilege?
- [x] Providing users with only the access necessary to perform their jobs
- [ ] Regularing updating user privileges
